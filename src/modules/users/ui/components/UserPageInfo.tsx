...
import SubscriptionButton from "@/modules/subscription/ui/component/SubscriptionButton";
        ...
        <div className="py-6">
            ...
            <div className="hidden md:flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <Skeleton className="h-6 mt-4 w-48" />
    ...
    <div className="py-6">
      <div className="flex flex-col md:hidden">
        ...
        {user.clerkId === userId ? (
          ...
          >
            <Link prefetch href="/studio" className="">
              Go To Studio
            </Link>
          </Button>
        ) : (
